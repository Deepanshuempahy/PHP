...
<body>
	<div class="main-container">
		<div class="main">
			...
			<div class="box">
				<button type="button" class="box1" style="margin-right: 20%;"><a href="restiger.php" style="text-decoration: none; color: white; font-size: 15px;">Register and Create a<br> New Profile Page</a></button>
